...
to-report scatter01  ;; incentivise scattering, not clustering!
  let rew cluster
  ;if (ticks > 0)
    ;[
    set rew
        ...
        +
        ((cluster / cluster-threshold) * (penalty ^ 2))
        +
...
to-report scatter02  ;; incentivise scattering, not clustering!
  let rew cluster
  ;if (ticks > 0)
    ;[
    set rew
...
to log-params  ;; NB explicitly modify lines "e-greedy", "OBSERVATION SPACE", and "REWARD" (everything else is logged automatically)
  ...
  file-type "OBSERVATION SPACE: " file-type "chemical-0-here " file-type "chemical-1-here " file-type "in-cluster-0 " file-print "in-cluster-1"
...
@#$#@#$#@
<experiments>
  <experiment name="test-02" repetitions="1" runMetricsEveryStep="false">
  ...
  <experiment name="test-03" repetitions="1" runMetricsEveryStep="false">
    <setup>setup-learning</setup>
    <go>learn</go>
    <exitCondition>episode &gt; episodes</exitCondition>
    <enumeratedValueSet variable="sniff-angle">
  ...
  <experiment name="test-04" repetitions="1" runMetricsEveryStep="false">
    <setup>setup-learning</setup>
    <go>learn</go>
    <exitCondition>episode &gt; episodes</exitCondition>
    <enumeratedValueSet variable="sniff-angle">
  ...
  <experiment name="chem-grad-singleton" repetitions="1" runMetricsEveryStep="false">
    <setup>setup-learning</setup>
    <go>learn</go>
    <exitCondition>episode &gt; episodes</exitCondition>
    <enumeratedValueSet variable="sniff-angle">
  ...
  <experiment name="chem-grad-02" repetitions="1" runMetricsEveryStep="false">
    <setup>setup-learning</setup>
    <go>learn</go>
    <exitCondition>episode &gt; episodes</exitCondition>
    <enumeratedValueSet variable="sniff-angle">

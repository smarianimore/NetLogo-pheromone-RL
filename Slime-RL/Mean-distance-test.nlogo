...
to setup
  ...
  ask turtles [
    foreach [self] of turtles
      [ t ->
          if t != self [ set distance_vector lput precision distance t 2 distance_vector ]
      ]
  ]
  show distance_vector
  show precision mean distance_vector 2
  show precision standard-deviation distance_vector 2
  show precision min distance_vector 2
end
